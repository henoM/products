                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <a href="{{route('file.add', $product->id)}}" class="btn btn-primary">Add Files</a>
                                        <a href="{{route('product.update', $product->id)}}" class="btn btn-success btn-xs">update</a>
                                        <a href="{{route('product.delete', $product->id)}}" class="btn btn-danger btn-xs">delete</a>
                                    </div>
                                </div>
                                <div class="col-md-8">
